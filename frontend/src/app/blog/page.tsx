...
const fallbackBlogs: BlogPost[] = [
  { id: 1, title: 'The Role of AI and Robotics in Modern Education', slug: 'role-of-ai-robotics-modern-education', content: '<p>Artificial Intelligence (AI) and robotics are no longer concepts confined to sci-fi novels. In today\'s pedagogical landscape, they play an essential role in training student minds to think computationally. At Lather High School, our advanced lab features automated robotic arms and IoT boards that let students code and build active solutions to real-world problems. Discover how this hands-on engineering is shaping future engineers.</p>', category: 'Technology', featuredImage: '/images/computer-lab.jpg', draft: false, publishedAt: new Date().toISOString() },
  { id: 2, title: 'Fostering a Culture of Reading: The LA Literary Program', slug: 'fostering-culture-of-reading-literary-program', content: '<p>In an age dominated by screens and prompt reels, deep-focus reading has become an endangered skill. Our library program at Lather High School challenges this trend. By scheduling dedicated reading hours and engaging students in literary debate, we help them develop strong analytical vocabulary and deep empathy. Read on to find out how our English faculty helps students love literature.</p>', category: 'Academics', featuredImage: '/images/library.jpg', draft: false, publishedAt: new Date().toISOString() }
];
